...
MODELS = [
    ...
    {"id": "gpt-image-1.5", "provider": "kie", "kind": "image", "title": "GPT Image 1.5", "docs": "https://docs.kie.ai/market/gpt-image/1-5-text-to-image", "kie_model": "gpt-image/1.5-text-to-image", "roles": ["concept", "ui"]},
    {"id": "gpt-image-1", "provider": "kie", "kind": "image", "title": "GPT Image 1 / 4o", "docs": "https://docs.kie.ai/market/gpt/gpt-image-2-text-to-image", "kie_model": "gpt-image-2-text-to-image", "roles": ["concept"]},
    ...
    {"id": "grok-imagine-video-1.5", "provider": "kie", "kind": "video", "title": "Grok Imagine Video", "docs": "https://docs.kie.ai/market/grok-imagine/text-to-video", "kie_model": "grok-imagine/text-to-video", "roles": ["cinematic"]},
    ...
    {"id": "elevenlabs-tts", "provider": "kie", "kind": "audio", "title": "ElevenLabs TTS", "docs": "https://docs.kie.ai/market/elevenlabs/text-to-speech-multilingual-v2", "kie_model": "elevenlabs/text-to-speech-multilingual-v2", "roles": ["voice"]},
    ...
    {"id": "suno", "provider": "kie", "kind": "music", "title": "Suno", "docs": "https://docs.kie.ai/suno-api/generate-music", "kie_model": "V5", "task_api": "suno", "roles": ["music"]},
